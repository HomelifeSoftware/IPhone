  ...
  try {
    ...
    adminProductsGrid.innerHTML = products
      .map((product, index) => {
        ...
        return `
                <div class="admin-product-card" style="animation-delay: ${
                  index * 0.1
                }s">
                    <div class="admin-product-image">
                        <img src="${product.image}" alt="${
          product.name
        }" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22400%22 height=%22400%22%3E%3Crect fill=%22%23f5f5f7%22 width=%22400%22 height=%22400%22/%3E%3Ctext fill=%22%2386868b%22 font-family=%22sans-serif%22 font-size=%2220%22 x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22%3E${
          product.name
                    ...
                    <div class="admin-product-info">
                        ...
                        <div class="admin-product-actions">
                            ...
                            <button class="btn-danger" onclick="deleteProductById(${
                              product.id
                            })">
...
async function renderAdminOrders() {
  try {
    ...
    adminOrdersContainer.innerHTML = orders
      .map(
        (order, index) => `
            <div class="admin-order-card" style="animation-delay: ${
              index * 0.05
            }s">
                ...
                <div style="margin: 20px 0; padding: 20px; background: var(--bg-gray); border-radius: 10px;">
                    <div style="margin-bottom: 10px; display: flex; align-items: center; gap: 8px;"><span class="material-icons" style="font-size: 18px;">person</span><strong>Customer:</strong> ${
                      order.name
                    }</div>
                    <div style="margin-bottom: 10px; display: flex; align-items: center; gap: 8px;"><span class="material-icons" style="font-size: 18px;">email</span><strong>Email:</strong> ${
                      order.email
                    }</div>
                    <div style="margin-bottom: 10px; display: flex; align-items: center; gap: 8px;"><span class="material-icons" style="font-size: 18px;">phone</span><strong>Phone:</strong> ${
                      order.phone
                    }</div>
                    <div style="display: flex; align-items: center; gap: 8px;"><span class="material-icons" style="font-size: 18px;">location_on</span><strong>Address:</strong> ${
                      order.address
                    }</div>
                </div>
                <div>
                    ...
                    ${order.items
                      .map(
                        ...
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px; padding: 10px; background: var(--bg-gray); border-radius: 8px;">
                            ...
                            <span style="font-weight: 600; color: var(--primary-color);">TSh ${(
